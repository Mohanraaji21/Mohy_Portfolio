export const techStack = [
  ...
  { name: "Java", link: "https://img.icons8.com/?size=100&id=Pd2x9GWu9ovX&format=png&color=000000" },
  { name: "SpringBoot", link: "https://img.icons8.com/?size=100&id=90519&format=png&color=000000" },
...
export const contactLinks = [{ name: 'Stack Overflow', url: 'https://img.icons8.com/external-tal-revivo-color-tal-revivo/40/000000/external-stack-overflow-is-a-question-and-answer-site-for-professional-logo-color-tal-revivo.png', link: 'https://stackoverflow.com/users/29737677/artistic-mohan' },
{ name: 'Instagram', url: 'https://img.icons8.com/doodle/40/000000/instagram-new--v2.png', link: 'https://www.instagram.com/mohy_jake_21/' },
{ name: 'Github', url: 'https://img.icons8.com/doodle/40/000000/github--v1.png', link :'https://github.com/Mohanraaji21'},
{ name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png', link: 'https://www.linkedin.com/in/mohanraaji-b-85b34a289/'}
]
...
export const serviceData = [
  ...
  },
  {
    ...
    desc: `We specialize in creating visually appealing, responsive, and 
    high-performance websites using modern frontend technologies. 
    Our services include custom web design, UI/UX development, 
    interactive components, and seamless integration with backend APIs.`,
